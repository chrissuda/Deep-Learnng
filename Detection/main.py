...
print("\n994+100 with freezing all but roi_head's layers while training on NYC")
...
# print("\n994+100 with freezing all but box_predictor while training on NYC")
...
# loader_val=Loader(val_labelbox,batch_size=batch_size)
# checkAp(model,loader_val,device,THRESHOLD_SCORE=0,NMS=True,isFilter=True)
